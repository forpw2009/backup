...
[task_local]
#9.14~9.18 礼惠国庆大牌欢乐购
30 9 14-18 9 * https://raw.githubusercontent.com/smiek2221/scripts/master/gua_opencard32.js, tag=9.14~9.18 礼惠国庆大牌欢乐购, enabled=true

================Loon==============
[Script]
cron "30 9 14-18 9 *" script-path=https://raw.githubusercontent.com/smiek2221/scripts/master/gua_opencard32.js,tag=9.14~9.18 礼惠国庆大牌欢乐购

===============Surge=================
9.14~9.18 礼惠国庆大牌欢乐购 = type=cron,cronexp="30 9 14-18 9 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/smiek2221/scripts/master/gua_opencard32.js

============小火箭=========
9.14~9.18 礼惠国庆大牌欢乐购 = type=cron,script-path=https://raw.githubusercontent.com/smiek2221/scripts/master/gua_opencard32.js, cronexpr="30 9 14-18 9 *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                '14826914f3514f6ea6718407406411a2',
            ]
            $.bean = 0;
